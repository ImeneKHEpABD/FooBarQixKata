...
namespace FooBarQixToolkit.Tests
{
    ...
    {
        public FooBarQix foobarqix = new FooBarQix(new FooBarQixOperations(new FooBarQixRuleContains(), new FooBarQixRuleDividers()));
        ...
        {
            var computed = foobarqix.Compute(number);
